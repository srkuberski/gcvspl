/* gcvspl.f -- translated by f2c (version 20190311).
...
/*       N       ( I )   Number of observations per dataset, with N.ge.2* */
/* M. */
...
/*                       degrees of freedom can be obtained, for identica */
/* l */
...
/* , */
/*                       only a single column of C(N,K) is needed, and th */
/* e */
/*                       proper column C(1,J), with J=1...K should be use */
/* d */
/*                       when calling SPLDER. */
...
/*       This subroutine is an adaptation of subroutine PREP from the pap */
/* er */
...
/*                               difference with the prior given number o */
/* f */
...
/*                               relative inverse variance of each measur */
/* e- */
/*                               ment, with WX(I) > 0.0. */
/*       WY(K)           ( I )   Weight factors, corresponding to the */
/*                               relative inverse variance of each datase */
/* t, */
/*                               with WY(J) > 0.0. */
...
/* : */
/*                               the dimensions of in GCVSPL and in SPLDE */
/* R */
/*                               are different! In SPLDER, only a single */
/*                               column of C(N,K) is needed, and the prop */
/* er */
/*                               column C(1,J), with J=1...K, should be u */
/* sed */
/*                               when calling SPLDER. */
...
/*                               subroutine GCVSPL. */
/*       B (1-M:M-1,N)   ( I )   B-spline tableau as evaluated by subrout */
/* ine */
/*                               BASIS. */
